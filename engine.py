...
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--small_log', action='store_true', help='Use compressed logging format')
    parser.add_argument('--bot1', type=str, default=None, help='Path to bot 1 file (overrides config)')
    parser.add_argument('--bot2', type=str, default=None, help='Path to bot 2 file (overrides config)')
    parser.add_argument('--name1', type=str, default=None, help='Name for bot 1 (overrides config)')
    parser.add_argument('--name2', type=str, default=None, help='Name for bot 2 (overrides config)')
    args = parser.parse_args()

    if args.bot1: BOT_1_FILE = args.bot1
    if args.bot2: BOT_2_FILE = args.bot2
    if args.name1: BOT_1_NAME = args.name1
    if args.name2: BOT_2_NAME = args.name2
